export default {
  ...
  visualization: {
    ...
    set_var: '設置變量',
    var_name: '變量名',
    var_name_placeholder: '請輸入變量名（bool）',
    var_toggle: '取反（toggle）',
    var_set: '設為指定值',
    var_set_value: '變量值',
    visibility_by_var: '顯隱（變量控制）',
    visibility_condition: '顯隱條件',
    visibility_source: '條件來源',
    visibility_source_runtime_var: '交互變量',
    visibility_source_dataset: '動態數據',
    data_source_component: '數據來源組件',
    data_source_placeholder: '請選擇數據來源組件',
    dataset_field: '數據字段',
    dataset_field_placeholder: '請選擇數據字段',
    value_type: '值類型',
    value_type_string: '文本',
    value_type_number: '數值',
    value_type_boolean: '布爾',
    compare_operator: '比較符',
    compare_value: '比較值',
    operator_eq: '等於',
    operator_ne: '不等於',
    operator_gt: '大於',
    ...
    operator_empty: '為空',
    operator_not_empty: '不為空',
    var_true_show: '規則：變量為 true 時顯示',
    var_missing_strategy: '變量缺失時',
    show_close_button: '顯示關閉按鈕（點擊取反變量）',
    runtime_vars_default: '交互變量（預設值）',
    runtime_vars_default_tips: '用於預覽態交互變量初始化（bool），僅補缺不覆蓋運行中值',
    runtime_vars_empty: '暫無變量，可點擊右側添加',
    board: '邊框',
    color: '顏色',
    board_width: '線寬',
    board_radius: '圓角',
