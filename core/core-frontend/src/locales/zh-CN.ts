export default {
  ...
  visualization: {
    ...
    set_var: '设置变量',
    var_name: '变量名',
    var_name_placeholder: '请输入变量名（bool）',
    var_toggle: '取反（toggle）',
    var_set: '设为指定值',
    var_set_value: '变量值',
    visibility_by_var: '显隐（变量控制）',
    visibility_condition: '显隐条件',
    visibility_source: '条件来源',
    visibility_source_runtime_var: '交互变量',
    visibility_source_dataset: '动态数据',
    data_source_component: '数据来源组件',
    data_source_placeholder: '请选择数据来源组件',
    dataset_field: '数据字段',
    dataset_field_placeholder: '请选择数据字段',
    value_type: '值类型',
    value_type_string: '文本',
    value_type_number: '数值',
    ...
    var_true_show: '规则：变量为 true 时显示',
    var_missing_strategy: '变量缺失时',
    show_close_button: '显示关闭按钮（点击取反变量）',
    runtime_vars_default: '交互变量（默认值）',
    runtime_vars_default_tips: '用于预览态交互变量的初始化（bool），仅补缺不覆盖运行中值',
    runtime_vars_empty: '暂无变量，可点击右侧添加',
    board: '边框',
    color: '颜色',
    board_width: '线宽',
    board_radius: '圆角',
