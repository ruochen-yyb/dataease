export default {
  ...
  visualization: {
    ...
    var_name_placeholder: 'Enter a boolean variable name',
    var_toggle: 'Toggle',
    var_set: 'Set',
    var_set_value: 'Value',
    visibility_by_var: 'Visibility (by Variable)',
    visibility_condition: 'Visibility Condition',
    visibility_source: 'Condition Source',
    visibility_source_runtime_var: 'Runtime Variable',
    visibility_source_dataset: 'Dynamic Data',
    data_source_component: 'Data Source Component',
    data_source_placeholder: 'Select a data source component',
    dataset_field: 'Data Field',
    dataset_field_placeholder: 'Select a data field',
    ...
    var_true_show: 'Rule: show when variable is true',
    var_missing_strategy: 'When variable is missing',
    show_close_button: 'Show close button (toggle variable)',
    runtime_vars_default: 'Interactive Variables (Defaults)',
    runtime_vars_default_tips:
      'Initialize preview runtime boolean variables (only fill missing keys)',
    runtime_vars_empty: 'No variables yet. Click Add to create one.',
    board: 'Border',
    color: 'Color',
